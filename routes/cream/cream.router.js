...
route.get("/selectAll", queryCreamDataAll); // done 100 % lawm os
route.get("/searchByName", searchCreamData); // done 100 % lawm os
route.get("/selectOne", queryCreamDataOne); // done 100 % lawm os
