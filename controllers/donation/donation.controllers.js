...
// 	SET id=?, donation_name=?, donation_detail=?, moredetail_url=?, total_people_dnt=?, total_dnt=?, close_date=?, status_detail=?, paid_detail=?, paid_image=?, cdate=?
// 	WHERE <condition>;

// SELECT id, donation_name, donation_detail, moredetail_url, total_people_dnt, total_dnt, close_date, status_detail, paid_detail, paid_image, cdate
// 	FROM public.tbdonation;
...
// 	id, orderid, custtel, custname, donation_for_projectid, total_dnt, image, cdate)
// 	VALUES (?, ?, ?, ?, ?, ?, ?, ?);
